...
const connectionString = `mongodb+srv://${process.env.MONGOOSENAME}:${process.env.MONGOOSEPASSWORD}@mongobdtest.vsef73t.mongodb.net/Inventory?retryWrites=true&w=majority`
...
app.post('/create_items', async (req,res) => {
    ...
    const {priceNumber: price, inventoryNumber: inventory, nextDelivery: nextDelivery, delivery: delivery, name: name} = req.body;
